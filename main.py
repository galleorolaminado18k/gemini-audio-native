...
# -----------------------------
# Gemini API (con tu nueva API Key)
# -----------------------------
API_KEY = "AIzaSyDf9n-nERTfTC3G4WRf7msqQP1gjZkZST0"  # <- tu nueva API Key fija
...
def chat():
    try:
        ...
        # Guardar audio en caché y generar URL
        audio_id = str(uuid4())
        audio_cache[audio_id] = base64.b64decode(audio_base64)
